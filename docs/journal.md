...
After making progress but not finishing the part I wanted to do, I added the latest sensors, whether the PIR sensor or the photoresistor, to my database, and made the codes for adding, deleting and displaying them to make sure my programs worked.
